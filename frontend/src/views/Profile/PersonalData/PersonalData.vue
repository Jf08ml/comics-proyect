<template>
  <div class="container-personal-data">
    <div class="section-title">
      ...
      <Transition>
        <ModalDefault
          ...
          :onShowModal="closeModalFromComponent"
        >
          <FormUploadPhoto
            v-if="showComponent"
      ...
      <div>
        <p align="center">
          Section to modify personal data, account and password
        </p>
      </div>
    </div>
    <div class="section-content">
      <FormUserData
        :userData="userData"
        :onSubmitUserInformation="onSubmitUserInformation"
      />
...
const profilePicClass = computed(() => ({
  "profile-pic-profile": !userUrlPhoto.value,
}));
